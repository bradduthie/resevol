...
subtitle: The evolutionary algorithm (Supporting Information 1)
author: |
...
To then get the value of the first column of four hidden layer nodes (i.e., the first column of blue squares in Figure A), we can use matrix multiplication.
