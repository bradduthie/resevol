...
plot(x=0, y=0, type="n", xlim=c(0,100), ylim=c(40,95), xaxt="n", yaxt="n",
     xlab="",ylab="");
ibox <- mbox(x0 = 0,  x1 = 10, y0 = 63, y1 = 47);
...
polygon(x = tbox$x, y = tbox$y, lwd = 3, border = "black", col = "white");
text(x=5,  y=58, labels="Initialise", col="black", cex = 0.75);
text(x=5,  y=54, labels="pests and", col="black", cex = 0.75);
text(x=5,  y=50, labels="landscape", col="black", cex = 0.75);
text(x=5, y=84, labels="Crops and", col="black", cex = 0.75);
text(x=5, y=80, labels="pesticides", col="black", cex = 0.75);
text(x=5, y=76, labels="rotated?", col="black", cex = 0.75);
text(x=20, y=82, labels="Pests", col="black", cex = 0.75);
text(x=20, y=78, labels="metabolise", col="black", cex = 0.75);
text(x=35, y=82, labels="Pests", col="black", cex = 0.75);
text(x=35, y=78, labels="feed", col="black", cex = 0.75);
text(x=50, y=82, labels="Pesticide", col="black", cex = 0.75);
text(x=50, y=78, labels="consumed", col="black", cex = 0.75);
text(x=65, y=82, labels="Pests", col="black", cex = 0.75);
text(x=65, y=78, labels="move", col="black", cex = 0.75);
text(x=80, y=82, labels="Pests", col="black", cex = 0.75);
text(x=80, y=78, labels="reproduce", col="black", cex = 0.75);
text(x=95, y=82, labels="Pest", col="black", cex = 0.75);
text(x=95, y=78, labels="mortality", col="black", cex = 0.75);
text(x=95,  y=58, labels="Pests", col="black", cex = 0.75);
text(x=95,  y=54, labels="immigrate", col="black", cex = 0.75);
text(x=80,  y=59, labels="Collect", col="black", cex = 0.75);
text(x=80,  y=55, labels="statistics", col="black", cex = 0.75);
text(x=80,  y=51, labels="as CSV", col="black", cex = 0.75);
...
rbox <- mbox(x0 = 10, x1 = 16, y0 = 47, y1 = 63);
polygon(x = rbox$x, y = rbox$y, lwd = 5, border = "black", col = "black");
text(x=13, y=55, labels="START", col="white", cex = 1, srt = 90);
