...
These arguments are explained the package documentation, and in supporting information that demonstrates an advanced case study with a custom landscape and complex pest genomes and life history.
...
[Output files](#outputs) can be used to plot ecological and evolutionary dynamics of pests. 
...
Figure 4 shows the location of pests on the landscape


```{r landscape, echo=FALSE, fig.width=6, fig.height=6, fig.cap = "Last time step"}
