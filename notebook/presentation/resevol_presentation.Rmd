...
date: '[1] University of Stirling [2] University of Gothenburg [3] Gothenburgh Global Biodiversity Centre alexander.duthie@stir.ac.uk, @bradduthie@ecoevo.social http://bradduthie.github.io/talks/resevol.pdf'
output:
  beamer_presentation:
    theme: "default"
    colortheme: "default"
...
## Negatively correlated cross-resistance between pesticides


```{r, echo = FALSE, fig.width = 4.65, fig.height = 4.65}
var1 <- runif(n = 120, min = 0, max = 1);
var2 <- rnorm(n = 120, sd = 0.2) - var1;
par(mgp=c(0.2,1,0))  
plot(x = var1, y = var2, xaxt = "n", yaxt = "n", pch = 20, cex = 1.25,
     xlab = "Resistance to pesticide A", ylab = "Resistance to pesticide B",
     cex.lab = 1.25);
par(mgp=c(3,1,0))
```
