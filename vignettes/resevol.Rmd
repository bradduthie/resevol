...
The function initialises a population of `npsize` networks (Figure 1), and this population evolves until some maximum generation (`max_gen`) or minimum expected network stress (`term_cri`) is met. 
