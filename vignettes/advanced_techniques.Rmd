...
end_trait_covs <- cov(pop_last_time_step_sim2[,3:6]);
print(end_trait_covs);
```
...
Overall, farms therefor did not experience high densities of pests, and pest resistance to pesticide is well-managed (Figure 11).
