...
Additional guidance can be found in the [package notes](https://bradduthie.github.io/helicoverpa/notebook/helicoverpa_notes.html) on GitHub and the package documentation. Any queries concerning guidance for setting up and running simulations can be posted on the [GitHub issues page](https://github.com/bradduthie/helicoverpa/issues) or emailed to the package maintainer Brad Duthie (see email address in the [package DESCRIPTION](https://github.com/bradduthie/helicoverpa/blob/master/DESCRIPTION)). This package has mainly been developed to facilitate ongoing modelling work at the University of Stirling, but it is open source and free to use. Comments and questions are welcome.
