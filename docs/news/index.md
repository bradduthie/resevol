...
- New argument `pesticide_threshold` sets density threshold for
  pesticide
...
- Fixed issue causing an error for scalar `food_consume` or
  `pesticide_consume`
...
- New argument allowing users to set initialised means for evolving
  traits
